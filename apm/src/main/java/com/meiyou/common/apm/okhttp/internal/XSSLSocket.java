...
public class XSSLSocket extends SSLSocket {
    ...
    public XSSLSocket(SSLSocket sslSocket) {
        super();
        this.impl = sslSocket;
        hostName = sslSocket.getInetAddress().getHostName();
    }
...
//        LogUtils.d("TCP connect: socket=" + endpoint + " connectTime=" + connectTime + "ms");
//        ApmHelper.getInstance().onTcp(endpoint, connectTime);
    }
...
//            }
        ...
        // 记录SSL握手时间
        handshakeTime = System.currentTimeMillis() - startTime;
//        LogUtils.d("handshakeTime: " + handshakeTime);

//        ApmHelper.getInstance().onSSL(hostName, handshakeTime);
    }
